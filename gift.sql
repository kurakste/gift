...
# Схема: gift
# Время создания: 2018-12-13 04:36:36 +0000
# ************************************************************
...
VALUES
	...
	(7,78,500.00,1000.00,'2018-12-12','2019-01-31');
...
VALUES
	...
	(3,3000.00,4000.00,'945N-7ZF2WE',1,'Igor','89176450029','kurakste@gmail.com','Lena','89869347745','2018-12-08 12:54:22','2018-12-03 00:00:00','0000-00-00 00:00:00',1),
	(4,3000.00,4000.00,'TEST-CRTF',1,'Степан','9176450029','kurakste@gamil.ru','Елена','+79869347745','2018-12-12 20:21:58',NULL,NULL,2);
...
VALUES
	...
	(11,78,'kirov_spa','/img/products/spa-relax.png',1);
...
VALUES
	...
	(9,1,2,3,'Релакс и красота.','Релакс и красота.','relax-and-buty','Это два часа СПА процедур в одном из самых профисиональных салонов города.','Это два часа СПА процедур в одном из самых профисиональных салонов города.',90,0,0),
	(10,2,2,4,'Пол года на здоровье.','Пол года на здоровье.','fitnes','Абонимент в фитнескоплекс на 3 мес.','Подарите три месяца здорового образа жизни для ваших родных и близких людей.',90,0,0),
	(16,1,2,1,'Квест Сайлент Хилл','Приключение \"Сайлент Хилл\" на 6-ть персон.','silent-hill1','Крутой и страшный квест. Дух захватывает как страшно. Получите острые ощущения.','Это полное описание крутого и классного квеста.',90,0,0),
	...
	(23,2,1,1,'Квест Сайлент Хилл','Приключение \"Сайлент Хилл\" на 6-ть персон.','silent-hill8','Крутой и страшный квест. Дух захватывает как страшно. Получите острые ощущения.','Это полное описание крутого и классного квеста.',90,0,0),
	(24,2,1,1,'Квест Сайлент Хилл','Приключение \"Сайлент Хилл\" на 6-ть персон.','silent-hill9','Крутой и страшный квест. Дух захватывает как страшно. Получите острые ощущения.','Это полное описание крутого и классного квеста.',90,0,0),
	...
	(26,2,1,4,'Пол года на здоровье.','Пол года на здоровье.','fitnes2','Абонимент в фитнескоплекс на 3 мес.','Подарите три месяца здорового образа жизни для ваших родных и близких людей.',90,0,0),
	...
	(71,2,2,2,'Чумовой заезд 2','Чумовой заезд. Гонка на картингах для банды в 6-ть человек.','mad-raice3','Гонка на картингах для банды в 6-ть человек. Три заезда по три минуты. Лучший получит кубок от заведения!','Гонка на картингах для банды в 6-ть человек. Три заезда по три минуты. Лучший получит кубок от заведения!Гонка на картингах для банды в 6-ть человек. Три заезда по три минуты. Лучший получит кубок от заведения!Гонка на картингах для банды в 6-ть человек. Три заезда по три минуты. Лучший получит кубок от заведения!',90,0,0),
	(72,2,2,2,'Чумовой заезд 2','Чумовой заезд. Гонка на картингах для банды в 6-ть человек.','mad-raice4','Гонка на картингах для банды в 6-ть человек. Три заезда по три минуты. Лучший получит кубок от заведения!','Гонка на картингах для банды в 6-ть человек. Три заезда по три минуты. Лучший получит кубок от заведения!Гонка на картингах для банды в 6-ть человек. Три заезда по три минуты. Лучший получит кубок от заведения!Гонка на картингах для банды в 6-ть человек. Три заезда по три минуты. Лучший получит кубок от заведения!',90,0,0),
	...
	(74,2,2,2,'Чумовой заезд 2','Чумовой заезд. Гонка на картингах для банды в 6-ть человек.','mad-raice6','Гонка на картингах для банды в 6-ть человек. Три заезда по три минуты. Лучший получит кубок от заведения!','Гонка на картингах для банды в 6-ть человек. Три заезда по три минуты. Лучший получит кубок от заведения!Гонка на картингах для банды в 6-ть человек. Три заезда по три минуты. Лучший получит кубок от заведения!Гонка на картингах для банды в 6-ть человек. Три заезда по три минуты. Лучший получит кубок от заведения!',90,0,0),
	...
	(78,1,1,5,'Массаж в г Киров от ООО Массажист','Супер релакс.','relax_super','Супер релакс.','sdfsdf',90,2,0);
...
VALUES
	...
	(5,2,'Масажный салон','равыфлоарлвоа','/лывфаодывла','Лена, 8-197-890-89-09');
