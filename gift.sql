...
# Схема: gift
# Время создания: 2018-11-19 07:06:24 +0000
# ************************************************************
...
VALUES
	(1,' Девушкам.','fmail','Подарки для прекрасных дам. ','/img/category/forher.jpg'),
	(2,'Парням.','male','Подарки для сильной половины.','/img/category/forhim.jpg'),
	(9,'Детям','children','Подарки для детей','/img/category/boy.jpg'),
	(10,'Родителям','parents','Для родителей.','/img/category/parents.jpg'),
