...
class m181201_194459_certificate extends Migration
{
    ...
    public function up()
    {
         $this->createTable('certificates', [
            ...
            'donor_name' => Schema::TYPE_STRING.' NOT NULL',
            'donor_phone' => Schema::TYPE_STRING.' NOT NULL',
            'donor_email' => Schema::TYPE_STRING.' NOT NULL',
            'recipient_name' => Schema::TYPE_STRING.' NOT NULL',
            'recipient_phone' =>Schema::TYPE_STRING.' NOT NULL',
